...
/* Detects MOSQUITO-style acoustic covert channel activity by monitoring the Zero-Crossing Rate (ZCR) of the digital audio stream. 
Legitimate speech/music has bounded, low ZCR. 
Ultrasonic/near-Nyquist modulation used to exfiltrate dathrough speaker hardware produces abnormally high ZCR.
This module counts sign transitions over a fixed sample window and flags an alert if the count exceeds a configurable threshold. 
Fully synthesizable, no floating  point, no FFT.
*/
